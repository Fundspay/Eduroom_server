...
const uploadProfilePicture = multer({
  storage: buildS3Storage("1eduroom-registration-details/profile"),
...
const uploadGeneralFile = multer({
  storage: buildS3Storage("1eduroom-registration-details/domain-images"),
...
const uploadGeneralFile2 = multer({
  storage: buildS3Storage("1eduroom-registration-details/course-images"),
  limits: { fileSize: 50 * 1024 * 1024 }, // 50MB
  fileFilter: imageFileFilter,
});
