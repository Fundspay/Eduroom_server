...
module.exports = (sequelize, Sequelize) => {
  const Course = sequelize.define(
    "Course",
    {
      ...
      // ✅ New fields
      img2: { type: Sequelize.STRING, allowNull: true },
      domainSkills: { type: Sequelize.STRING, allowNull: true }, 
      interpersonalSkills: { type: Sequelize.STRING, allowNull: true },
      managerName: { type: Sequelize.STRING, allowNull: true },
      managerPosition: { type: Sequelize.STRING, allowNull: true },
