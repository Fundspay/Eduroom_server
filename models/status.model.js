...
module.exports = (sequelize, Sequelize) => {
    const Status = sequelize.define(
        "Status",
        {
            ...
            fundswebReferralCode: { type: Sequelize.STRING, allowNull: true },
            fundswebSubscriptionId: { type: Sequelize.STRING, allowNull: true },
            fundswebMonths: { type: Sequelize.INTEGER, allowNull: true },
            fundswebAmount: { type: Sequelize.FLOAT, allowNull: true },
            fundswebStartDate: { type: Sequelize.DATE, allowNull: true },
            fundswebEndDate: { type: Sequelize.DATE, allowNull: true },
            fundswebPaymentStatus: { type: Sequelize.BOOLEAN, allowNull: true },
