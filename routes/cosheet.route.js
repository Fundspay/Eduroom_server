...
router.get("/busy/list/:managerName", cosheetController.getCoSheetByManagerBusy);
router.get("/switchoff/list/:managerName", cosheetController.getCoSheetByManagerSwitchoff);
router.get("/invalid/list/:managerName", cosheetController.getCoSheetByManagerInvalid);
