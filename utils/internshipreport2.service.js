...
const generateInternshipDetailsReport = async (userId, options = {}) => {
  ...
  <head>
    ...
    <style>
      ...
      .details-table {
        ...
        table-layout: fixed;
        margin: 0 auto;
        background: rgba(255,255,255,0.85); /* slightly opaque so bg shows through */
      }
      .details-table th,
      .details-table td {
      ...
      .value {
        width: 65%;
        color: #b00000; /* red values like screenshot */
      }

      /* Pagination control: allow table to break across pages, but avoid breaking inside rows */
      ...
      /* Small print adjustments for multi-page: keep header on each page */
      @media print {
  ...
  <body>
    <div class="sheet">
      <div class="header">
        <!-- left header/logo space - replace with your logo if desired -->
