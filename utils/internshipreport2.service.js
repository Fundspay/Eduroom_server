...
padding-bottom: 80px; /* Increased padding to prevent overlap with footer and background */
}
...
table-layout: fixed;
margin: 0 auto;
background: rgba(255,255,255,0.95); /* Slightly more opaque to ensure readability over background */
}
.details-table th,
.details-table td {
...
/* Page break rules - avoid breaking inside rows and ensure footer space */
...
/* Footer as running element for print, positioned outside content */
.footer {
display: block;
...
font-size: 12px;
color: #333;
background: rgba(255,255,255,0.9); /* Semi-transparent white background for footer to avoid watermark overlap */
padding: 5px;
margin: 0;
}
...
@media print {
body { padding-bottom: 60px; } /* Extra body padding for footer */
thead { display: table-header-group; }
tfoot { display: table-footer-group; }
.sheet { background-position: center top; background-size: cover; background-attachment: scroll; } /* Ensure background doesn't extend to footer */
}
</style>
</head>
<body>
...
<!-- Footer as running element to appear on every page without overlapping content or background -->
